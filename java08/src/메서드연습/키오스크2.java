...
//	final static int PRICE = 20000;
	final static int[] CHICKENPRICE = { 20000, 20000, 15000 };
	...
	public static void main(String[] args) {
		...
		f.setTitle("고추바사삭 갯수 : " + chickenCount[0] + "개, " + "불금 갯수 : " + chickenCount[1] + "개, " + "오리지날 갯수 : "
				+ chickenCount[2] + "개");
		...
		btn1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				chickenCount[0]++;
				totalCount++;
				totalPrice = totalPrice + CHICKENPRICE[0];
				countTotal.setText(totalCount + "개");
		...
		btn2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				chickenCount[1]++;
				totalCount++;
				totalPrice = totalPrice + CHICKENPRICE[1];
				countTotal.setText(totalCount + "개");
				total.setText(totalPrice + "원");
				f.setTitle("고추바사삭 갯수 : " + chickenCount[0] + "개, " + "불금 갯수 : " + chickenCount[1] + "개, " + "오리지날 갯수 : "
						+ chickenCount[2] + "개");
		...
		btn3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				chickenCount[2]++;
				totalCount++;
				totalPrice = totalPrice + CHICKENPRICE[2];
				countTotal.setText(totalCount + "개");
				total.setText(totalPrice + "원");
				f.setTitle("고추바사삭 갯수 : " + chickenCount[0] + "개, " + "불금 갯수 : " + chickenCount[1] + "개, " + "오리지날 갯수 : "
						+ chickenCount[2] + "개");
