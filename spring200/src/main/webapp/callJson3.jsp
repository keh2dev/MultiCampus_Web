...
<body>
<button id="b1">컨트롤러에서 bbs JSON(text)을 받아오자.!</button><br>
<button id="b11">컨트롤러에서 bbs JSON(table)를 받아오자.!</button><br>
<button id="b2">컨트롤러에서 bbs JSONArray를 받아오자.!</button><br>
<hr color="blue">
